...
def validate(plan):
    ...
    lines = optional_list(plan, "dialogue_timeline")
...
def compile_plan(plan, profile=None):
    ...
    for shot in plan["shots"]:
        ...
        sections = {
            ...
            "audio_or_sync": {"identity": copy.deepcopy(bible.get("audio_identity", {})), "dialogue": [x for x in plan.get("dialogue_timeline", []) if x["shot_id"] == shot["id"]], "audio": [x for x in plan.get("audio_timeline", []) if x["shot_id"] == shot["id"]]},
